# Dynamsoft Document Normalizer Samples - C/C++ Edition

This repository contains multiple samples that demonstrates how to use the <a href="https://www.dynamsoft.com/document-normalizer/docs/introduction/?ver=latest" target="_blank">Dynamsoft Document Normalizer</a> C/C++ Edition.
...
| Sample | Description |
|---|---|
| HelloWorld | This sample demonstrates the simplest way to normalize an image and save the result as an new image. |
